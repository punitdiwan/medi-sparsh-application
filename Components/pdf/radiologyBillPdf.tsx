...
interface Props {
    ...
    patientPhone: string;
    paymentMode: string;
    items: Array<{ testName: string; quantity: number; price: number; total: number }>;
    totalAmount: number;
    discount: number;
    tax: number;
    netAmount?: number;
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={contentWrapper}>
                    <View style={styles.section}>
                        ...
                        <Text>Patient: {props.patientName}</Text>
                        <Text>Phone: {props.patientPhone}</Text>
                        <Text>Payment Mode: {props.paymentMode}</Text>
                    </View>

                    {/* Radiology Test Table - Name, Quantity, Price */}
                    <View style={styles.section}>
                ...
                <View style={[styles.footer, styles.footerFixed]}>
                    <Text>Thank you for choosing our radiology services!</Text>
                </View>
            </Page>
        </Document>
    );
