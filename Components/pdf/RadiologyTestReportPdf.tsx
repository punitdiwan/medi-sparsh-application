...
export const RadiologyTestReportPdf: React.FC<Props> = ({
    patient,
    billDetails,
    reports,
    organization,
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    <Text style={styles.title}>RADIOLOGY TEST REPORT</Text>
                    ...
                    {reports.map((report, idx) => (
                        <View key={idx} style={styles.reportContainer} wrap={false}>
                            ...
                            <View style={styles.reportInfo}>
                                ...
                                <View style={styles.row}>
                                    <Text style={[styles.label, { width: 120 }]}>Technician / Date:</Text>
                                    <Text style={styles.value}>{report.technicianName || "N/A"} ({report.scanDate || "N/A"})</Text>
                                </View>
                                <View style={styles.row}>
                            ...
                            {/* Parameters Table for this Test (if parameters exist) */}
                            ...
                            {/* Findings Section */}
                            <View>
                                <Text style={styles.findingsTitle}>FINDINGS / RADIOLOGY REMARKS:</Text>
                                <Text style={styles.findingsText}>{report.findings || "No findings recorded for this test."}</Text>
                            </View>
                        </View>
                    ))}
                </View>
