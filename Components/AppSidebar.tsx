...
const items: SidebarItem[] = [
  ...
  { title: 'Prescription', url: '/doctor/prescription', icon: NotebookPen, subject: 'prescription', action: 'read', },
  {
    ...
    children: [
      { title: 'Billing', url: '/doctor/pharmacy', subject: 'pharmacy', action: 'read', },
      { title: 'Medicines', url: '/doctor/pharmacy/pharmacyMedicine', subject: 'pharmacyMedicine', action: 'read', },
      { title: 'Stock', url: '/doctor/pharmacy/stock', subject: 'stock', action: 'read', },
    ],
  },
  {
    title: 'Pathology',
    icon: FlaskConical,
    children: [
      { title: 'Billing', url: '/doctor/pathology', subject: 'pathology', action: 'read', },
      { title: 'Payments', url: '/doctor/pathology/pathologyPayment', subject: 'pathologyPayment', action: 'read', },
  ...
  },
  {
    ...
    icon: Microscope,
    children: [
      { title: 'Billing', url: '/doctor/radiology', subject: 'radiology', action: 'read', },
      { title: 'Payments', url: '/doctor/radiology/payments', subject: 'RadiologyBilling', action: 'read', },
  ...
  },
  {
    ...
    icon: Settings,
    children: [
      { title: 'Members', url: '/doctor/members', subject: 'members', action: 'read', },
      { title: 'Hospital Charges', url: '/doctor/settings/hospitalCharge', subject: 'hospitalCharge', action: 'read', },
      { title: 'Bed', url: '/doctor/settings/Bed', subject: 'bed', action: 'read', },
      { title: 'Shift Management', url: '/doctor/settings/shifts', subject: 'shifts', action: 'read', },
      { title: 'Symptoms', url: '/doctor/settings/symptom', subject: 'symptom', action: 'read' },
      { title: 'Vital', url: '/doctor/settings/vitals', subject: 'vitals', action: 'read', },
      { title: 'Operations', url: '/doctor/settings/operation', subject: 'operation', action: 'read' },
      { title: 'Medicine Record', url: '/doctor/settings/medicineRecord', subject: 'medicineRecord', action: 'read', },
      { title: 'Pathology', url: '/doctor/settings/pathologySettings', subject: 'pathologySettings', action: 'read' },
      ...
      { title: 'Payments History', url: '/doctor/payment', subject: 'payment', action: 'read', },
      { title: 'App Settings', url: '/doctor/settings/config', subject: 'appSetting', action: 'read', },
      { title: 'Roles', url: '/doctor/settings/role', subject: 'role', action: 'read', },
    ],
  },
];
