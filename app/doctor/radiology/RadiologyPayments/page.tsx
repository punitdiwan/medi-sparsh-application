import { getAllRadiologyPayments } from "@/lib/actions/radiologyBills";
import RadiologyPaymentsPage from "@/Components/doctor/radiology/RadiologyPaymentsPage";

export const dynamic = "force-dynamic";

export default async function Page() {
    const result = await getAllRadiologyPayments();
    ...
    return <RadiologyPaymentsPage payments={payments} />;
}
