...
interface ChartTooltipContentProps {
  active?: boolean;
  payload?: TooltipItem[]; // Use our own type here
  className?: string;
...
type ChartLegendContentPropsWithDiv = Omit<React.HTMLAttributes<HTMLDivElement>, "children"> &
...
function ChartTooltipContent({
  ...
  // Cast payload to TooltipItem[]
  const items = payload as TooltipItem[] | undefined;
...
function ChartLegendContent({
  ...
  nameKey,
  ...divProps
}: ChartLegendContentPropsWithDiv) {
  const { config } = useChart();
